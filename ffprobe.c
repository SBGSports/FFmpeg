...
static struct section sections[] = {
    ...
    [SECTION_ID_FRAME_SIDE_DATA] =     { SECTION_ID_FRAME_SIDE_DATA, "side_data", SECTION_FLAG_HAS_VARIABLE_FIELDS, {SECTION_ID_FRAME_SIDE_DATA_TIMECODE_LIST, -1 }, .element_name = "side_datum", .unique_name = "frame_side_data"},
